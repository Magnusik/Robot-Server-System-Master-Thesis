 ...
 * C/C++ source code generated on  : 17-Dec-2022 09:44:40
 */
         ...
         double *leftU, double *rightU)
{
  ...
  sDistance = (ticksLeft + ticksRight) / 2.0 * 0.71594118296093923;
  /* Theta change orientation [rad] in one sample */
  sTheta = (fabs(ticksRight) + fabs(ticksLeft)) / 2.0 * 0.71594118296093923 /
