...
COMPILER_COMMAND_FILE     = api_rtw_comp.rsp
CMD_FILE                  = api_rtw.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
MODELLIB                  = api.lib
...
SRCS = $(START_DIR)\api_data.c $(START_DIR)\rt_nonfinite.c $(START_DIR)\rtGetNaN.c $(START_DIR)\rtGetInf.c $(START_DIR)\api_initialize.c $(START_DIR)\api_terminate.c $(START_DIR)\api.c
...
OBJS = api_data.obj rt_nonfinite.obj rtGetNaN.obj rtGetInf.obj api_initialize.obj api_terminate.obj api.obj
...
api_data.obj : $(START_DIR)\api_data.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\api_data.c
...
api_initialize.obj : $(START_DIR)\api_initialize.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\api_initialize.c


api_terminate.obj : $(START_DIR)\api_terminate.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\api_terminate.c


api.obj : $(START_DIR)\api.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\api.c
