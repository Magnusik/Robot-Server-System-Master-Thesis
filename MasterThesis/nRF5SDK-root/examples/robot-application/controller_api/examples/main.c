...
#include "controller_api_terminate.h"
#include "rt_nonfinite.h"

/* Function Declarations */
static double argInit_real_T(void);

static void main_controller_api(void);
...
static void main_controller_api(void)
{
  ...
  /* Initialize function 'controller_api' input arguments. */
  setpointX_tmp = argInit_real_T();
  /* Call the entry-point 'controller_api'. */
  ...
  controller_api(setpointX_tmp, setpointX_tmp, setpointX_tmp, &waitingCommand,
