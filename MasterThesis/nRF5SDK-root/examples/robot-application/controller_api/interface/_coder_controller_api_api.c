 ...
 * File: _coder_controller_api_api.c
 *
                        ...
                        const mxArray *plhs[10])
{
  ...
  controller_api(setpointX, setpointY, newCommand, &waitingCommand, ticksLeft,
...
void controller_api_atexit(void)
{
  ...
  controller_api_xil_terminate();
  controller_api_xil_shutdown();
...
/*
 * File trailer for _coder_controller_api_api.c
 *
 * [EOF]
 */
