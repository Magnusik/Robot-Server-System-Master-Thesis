...
void vMotorSpeedControllerTask(void *pvParameters) {
    ...
    *************************************************/
    ...
    PID_parameters pid_parameters_left_motor, pid_parameters_right_motor;
    ...
    while (1) 
    {
        ...
        //vTaskDelay(MOTOR_SPEED_CTRL_TASK_DELAY_TIME / 1000.0 * configTICK_RATE_HZ - (xTaskGetTickCount() - ticks_since_startup));      //Remove time elapsed during calculation
		...
		*************************************************/
        ...
        /************************************************
		 * Reset PID integral on change in reference
		*************************************************/
        ...
        //NRF_LOG_INFO("Int left" NRF_LOG_double_MARKER, pid_parameters_left_motor.error_integral);
		...
		*************************************************/
            ...
            left_u += MOTOR_SPEED_CTRL_LEFT_FEED_FORWARD * sgn_2(left_motor_reference, 0.1);
		 ...
		 * Logging
		*************************************************/
       // printf("E: %f\t", pid_parameters_right_motor.error_previous);
        //printf("I: %f\t", pid_parameters_right_motor.error_integral);
...
void setMotorSpeedReference(int32_t left_motor, int32_t right_motor)
{
    ...
    left_motor_reference = left_motor_reference  / 250.0;  //Robot max velocity is approx 0.5m/s have some extra for turning
