function [uL,uR] = move_forward(thetaError,distanceRemaining,distanceDriven,destinationZone,maxDistanceTarget,u,waitingCommand,thetaIntegralError,sTime,thetaDerivativeError)
