...
#define NUM_DIST_SENSORS			4
	...
	#define IR_SENSOR_4_ANALOG_INPUT 	NRF_SAADC_INPUT_AIN4
	//Sensor calibration
	#define IR_MAX_DETECT_DISTANCE_MM 	1000
	#define COLLISION_THRESHOLD_MM		250 // org: 600
	#define IR_SENSOR_1_DIVIDER			117168.0
	#define IR_SENSOR_1_EXPONENT		-0.91
	#define IR_SENSOR_2_DIVIDER			548401.0
	#define IR_SENSOR_2_EXPONENT		-1.137
	#define IR_SENSOR_3_DIVIDER			206247.0
	#define IR_SENSOR_3_EXPONENT		-0.995
	#define IR_SENSOR_4_DIVIDER			219247.0
	#define IR_SENSOR_4_EXPONENT		-1.0
...
typedef enum {
  ...
  BACKWARD
	...
	#define WHEEL_CIRCUMFERENCE_MM		204  //Updated 09.10.2020
...
#define MOTOR_SPEED_CTRL_TASK_DELAY_TIME 100
